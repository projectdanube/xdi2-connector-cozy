...
<title>xdi2-connector-cozy</title>
...
<body>
	...
	<div id="main">
	<div class="header">
	<table cellpadding="5"><tr><td><img src="images/arrow.png" align="middle"></td><td><img src="images/cozy-logo.png" align="middle"></td><td><span id="appname">xdi2-connector-cozy</span></td></tr></table>
	</div>
	...
	<p>Make sure you have a Cozy URL and Password in the graph, before sending this XDI message.</p>
